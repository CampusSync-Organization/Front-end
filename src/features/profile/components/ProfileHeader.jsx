...
import { Camera, MapPin, Terminal, Edit3, UserRoundPlus, MessageSquare, MessagesSquare } from "lucide-react";
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-start gap-6">
                        ...
                        <div className="relative flex-shrink-0">
                            <div
                                className={`w-32 h-32 rounded-2xl bg-slate-200 flex items-center justify-center overflow-hidden ${isOwnProfile ? "cursor-pointer group" : ""
                                    }`}
                                onClick={isOwnProfile ? handleImageClick : undefined}
                            >
                                <img
                                    alt={`${user.firstName} ${user.lastName}`}
                                    className={`w-full h-full object-cover ${isOwnProfile ? "transition-opacity group-hover:opacity-90" : ""
                                        }`}
                                    src={avatar}
                                />
                                {isOwnProfile && (
