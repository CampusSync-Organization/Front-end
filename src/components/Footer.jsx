...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-[#14213D] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300">
              Where learning meets belonging. Find your people, build your
              future.
            </p>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold mb-4 text-[#FCA311]">Product</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="font-bold mb-4 text-[#FCA311]">Company</h4>
            <ul className="space-y-2 text-gray-300">
              <li>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-bold mb-4 text-[#FCA311]">Connect</h4>
            <div className="flex gap-4">
              <a
                href="mailto:hello@campussync.com"
                className="hover:text-[#FCA311] transition-colors"
                title="Email"
              >
